...
BasicGame.Game.prototype = {
  PLAYER_SPEED:300,
  preload: function () {
    this.load.audio('sound',['assets/explode.ogg']);
    this.load.image('titlepage', 'assets/titlepage.png');
    this.load.image('sea', 'assets/sea.png');
    this.load.image('bullet', 'assets/bullet.png');
    this.load.image('enemyBullet', 'assets/enemy-bullet.png');
    this.load.image('powerup','assets/pow1.png');
  ...
  create: function () {
    ...
    this.mysound = this.add.audio('sound');
  ...
  update: function () {
    ...
    //return to normal after getting hit
  ...
  fire: function(){
    ...
    if (this.nextFire < this.time.now && this.bullets.countDead() > 0
        && this.player.alive) {
  ...
  checkWave: function () {
    if (this.wave === 1 && this.score >= 2000) {
      this.wave = 2;
      this.spawnRate = [800, 2500];
    } else if (this.wave === 2 && this.score >= 4000) {
      this.wave = 3;
      this.spawnRate = [600, 2000];
    } else if (this.wave === 3 && this.score >= 5000) {
      this.wave = 4;
